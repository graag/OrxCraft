...
CEGUIAlertPopup::CEGUIAlertPopup(const string& name, const string& title):
    AlertPopup(name, title),
    m_message(NULL)
{
}

void CEGUIAlertPopup::Init ()
{
    orxASSERT(
    ...
    window->subscribeEvent (FrameWindow::EventCloseClicked,
	    Event::Subscriber (&CEGUIAlertPopup::OnCloseClicked, this));
    ...
    m_message = FindTextbox("AlertPopup/DynamicMessage");
}

void CEGUIAlertPopup::SetText(const string& message) {
    m_message->SetText(message);
}

bool CEGUIAlertPopup::OnCloseClicked (const CEGUI::EventArgs &e)
{
    OnClose();
