...
#ifndef __SCROLL_CEGUI_MULTI_LINE_EDITBOX_H__
#define __SCROLL_CEGUI_MULTI_LINE_EDITBOX_H__
/**
 * @file CEGUIMultiLineEditbox.h
 * @date 2013-06-06
 * @author graag@o2.pl
 *
 */
...
/** CEGUI Implementation of an Editbox with multiline support */
class CEGUIMultiLineEditbox : public ScrollEditbox
{
public:
    /** C-tor */
    explicit CEGUIMultiLineEditbox (ScrollFrameWindow *dialog);
...
private:
    ...
    CEGUI::MultiLineEditbox *m_ceEditbox;
};
#endif  // __SCROLL_CEGUI_MULTI_LINE_EDITBOX_H__
